const CACHE_NAME = "multi-game-scorer-v49";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=21",
  ...
  "./mobile-fix.css?v=3",
  "./polish.css?v=1",
  "./player-colours.css?v=4",
  "./favourites.css?v=3",
  "./dealer-tracker.css?v=1",
  "./general-setup.css?v=1",
  "./game-night-hub.css?v=3",
  "./five-dice-v47.css?v=1",
  "./five-dice-v48.css?v=1",
  "./boot-home.js?v=1",
  "./app.js?v=25",
  "./post-mvp.js?v=1",
  "./setup-fix.js?v=1",
  "./polish-pack.js?v=2",
  "./player-colour-labels.js?v=4",
  "./settings-label.js?v=2",
  "./favourites.js?v=2",
  "./dealer-tracker.js?v=1",
  "./general-setup.js?v=2",
  "./game-night-hub.js?v=3",
  "./five-dice-v47.js?v=1",
  "./five-dice-v48.js?v=2",
  "./games/index.js?v=22",
  "./games/shared.js?v=12",
  "./games/fiveHundred.js?v=13",
